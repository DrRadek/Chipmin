...
public partial class @Controls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""CameraScroll"",
                    ""type"": ""Value"",
                    ""id"": ""9936a222-fc38-4af9-aece-f713eee0572b"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                },
                {
                    ""name"": ""CollectorLeft"",
                    ""type"": ""Button"",
                    ""id"": ""253cdc19-45ee-43b5-9794-677979160521"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""CollectorRight"",
                    ""type"": ""Button"",
                    ""id"": ""3d570911-30b6-48cf-84a2-d1adb75dec1d"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""9fdab70c-e6b4-46bc-826e-8f90a3504195"",
                    ""path"": ""<Mouse>/scroll/y"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""b53103d4-7f9c-44c6-b324-b1e30c16c119"",
                    ""path"": ""<Keyboard>/q"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""CollectorLeft"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                },
                {
                    ""name"": """",
                    ""id"": ""8a635c76-0d21-41fa-ace2-d26b4634927e"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""CollectorRight"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
        },
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""dc7e8712-1f39-413a-8753-e29e2020f935"",
                    ""path"": ""<Keyboard>/tab"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_Player_CollectorLeft = m_Player.FindAction("CollectorLeft", throwIfNotFound: true);
        m_Player_CollectorRight = m_Player.FindAction("CollectorRight", throwIfNotFound: true);
        // UI
    ...
    private readonly InputAction m_Player_CollectorLeft;
    private readonly InputAction m_Player_CollectorRight;
    public struct PlayerActions
    {
        ...
        public InputAction @CollectorLeft => m_Wrapper.m_Player_CollectorLeft;
        public InputAction @CollectorRight => m_Wrapper.m_Player_CollectorRight;
        ...
        public void AddCallbacks(IPlayerActions instance)
        {
            ...
            @CollectorLeft.started += instance.OnCollectorLeft;
            @CollectorLeft.performed += instance.OnCollectorLeft;
            @CollectorLeft.canceled += instance.OnCollectorLeft;
            @CollectorRight.started += instance.OnCollectorRight;
            @CollectorRight.performed += instance.OnCollectorRight;
            @CollectorRight.canceled += instance.OnCollectorRight;
        }
    ...
    private List<IPlayerHandsWeaponsActions> m_PlayerHandsWeaponsActionsCallbackInterfaces = new List<IPlayerHandsWeaponsActions>();
    ...
    public struct PlayerHandsWeaponsActions
    {
        ...
        public void AddCallbacks(IPlayerHandsWeaponsActions instance)
        {
            if (instance == null || m_Wrapper.m_PlayerHandsWeaponsActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_PlayerHandsWeaponsActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IPlayerHandsWeaponsActions instance)
        {
            @_1.started -= instance.On_1;
            @_1.performed -= instance.On_1;
            @_1.canceled -= instance.On_1;
        ...
        public void RemoveCallbacks(IPlayerHandsWeaponsActions instance)
        {
            if (m_Wrapper.m_PlayerHandsWeaponsActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IPlayerHandsWeaponsActions instance)
        {
            foreach (var item in m_Wrapper.m_PlayerHandsWeaponsActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_PlayerHandsWeaponsActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    ...
    private List<IWeaponEditActions> m_WeaponEditActionsCallbackInterfaces = new List<IWeaponEditActions>();
    ...
    public struct WeaponEditActions
    {
        ...
        public void AddCallbacks(IWeaponEditActions instance)
        {
            if (instance == null || m_Wrapper.m_WeaponEditActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_WeaponEditActionsCallbackInterfaces.Add(instance);
            @OpenClose.started += instance.OnOpenClose;
            @OpenClose.performed += instance.OnOpenClose;
            @OpenClose.canceled += instance.OnOpenClose;
        }

        private void UnregisterCallbacks(IWeaponEditActions instance)
        {
            @OpenClose.started -= instance.OnOpenClose;
            @OpenClose.performed -= instance.OnOpenClose;
            @OpenClose.canceled -= instance.OnOpenClose;
        ...
        public void RemoveCallbacks(IWeaponEditActions instance)
        {
            if (m_Wrapper.m_WeaponEditActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IWeaponEditActions instance)
        {
            foreach (var item in m_Wrapper.m_WeaponEditActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_WeaponEditActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    ...
    public interface IPlayerActions
    {
        ...
        void OnCollectorLeft(InputAction.CallbackContext context);
        void OnCollectorRight(InputAction.CallbackContext context);
    }
